...
//	messageDataMap.put(MESSAGE_DATA_DB.LINK, MESSAGE_DATA_DB.LINK);
	...
	remindDataMap.put(REMIND_DATA_DB.REMINDMUSIC, REMIND_DATA_DB.REMINDMUSIC);
	...
	case CELL_DATA:
	    retval = db
		    .insert(TB_CELL_DATA, CELL_DATA_DB._ID, values);
	    myURI = CELL_DATA_DB.CONTENT_URI;
	    break;
	case MESSAGE_DATA:
	    retval = db
		    .insert(TB_MESSAGE_DATA, MESSAGE_DATA_DB._ID, values);
	    myURI = MESSAGE_DATA_DB.CONTENT_URI;
	    break;
	case REMIND_DATA:
	    retval = db
		    .insert(TB_REMIND_DATA, REMIND_DATA_DB._ID, values);
	    myURI = REMIND_DATA_DB.CONTENT_URI;
	    break;	  
	case ADDRESS_DATA:
	    retval = db
		    .insert(TB_ADDRESS_DATA, ADDRESS_DATA_DB._ID, values);
	...
	switch (sUriMatcher.match(uri)) {
	case CELL_DATA:
	    retval = db.update(TB_CELL_DATA, values, selection,
		    selectionArgs);
	    break;
	case CELL_DATA_ID:
	...
	case MESSAGE_DATA_ID:
	    ...
	    break;
	case REMIND_DATA:
	    retval = db.update(TB_REMIND_DATA, values, selection,
		    selectionArgs);
	    break;
	case REMIND_DATA_ID:
