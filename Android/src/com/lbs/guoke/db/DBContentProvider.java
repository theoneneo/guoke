...
public class DBContentProvider extends ContentProvider {
	...
	cellDataMap.put(CELL_DATA_DB.ADDRESS, CELL_DATA_DB.ADDRESS);
	cellDataMap.put(CELL_DATA_DB.INTRODUCTION, CELL_DATA_DB.INTRODUCTION);
	cellDataMap.put(CELL_DATA_DB.THUMIMG, CELL_DATA_DB.THUMIMG);
