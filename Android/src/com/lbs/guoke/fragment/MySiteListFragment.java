...
public class MySiteListFragment extends ListFragment {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    if (convertView == null) {
		convertView = (View) inflater.inflate(R.layout.item_site, parent, false);
		holder = new SiteViewHolder();
		holder.row_icon = (ImageView) convertView.findViewById(R.id.row_icon);
	    ...
	    holder.row_title.setText(MySiteModuleManager.instance().getSiteInfos().get(position).siteName);
	    return convertView;
	}
